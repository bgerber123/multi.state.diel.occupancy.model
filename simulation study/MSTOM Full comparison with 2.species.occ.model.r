...
rm(list=ls())
load("simulation study/sim.full.data")
...
mark.out
write.table(mark.out,file="simulation study/MARK.2.species/markout1.inp",sep=" ",quote = FALSE,row.names = FALSE)
...
load("simulation study/fit.simdata.Full.1.out")
