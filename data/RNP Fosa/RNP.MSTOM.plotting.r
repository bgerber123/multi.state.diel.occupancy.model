...
setwd("C:/Users/bgerber/Google Drive/MSTOM/multi.state.temporal.activity/data/RNP Fosa")
...
png(file="RNP.fosa.det.parms.png",res=200,units = "in",height=8,width=8)
...
png(file="RNP.fosa.parms.png",res=200,units = "in",height=8,width=8)
color_scheme_set("red")
...
png(file="RNP.fosa.State.Prob.png",res=200,units = "in",height=10,width=10)
par(mfrow=c(2,2))
